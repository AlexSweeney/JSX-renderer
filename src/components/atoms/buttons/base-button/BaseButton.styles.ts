export const BUTTON_STYLES = {
  default: 'rounded transition duration-200 font-medium ring-highlight h-[2.5rem] min-w-[2.5rem] px-2',
  hover: '',
  active: 'active:ring-2',
  focus: 'focus:ring-2 focus:outline-none',
  disabled: 'disabled:opacity-50 disabled:cursor-not-allowed disabled:active:ring-0 disabled:focus:ring-0',
  keydown: 'ring-2',
};
